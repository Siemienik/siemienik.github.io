...
-   **[ExcelJS](https://github.com/exceljs/exceljs)** (over 12,000 ⭐, over 1 000 000 downloads on NPM and with growing [Discord](https://discord.gg/siema) community) - Spreadsheet workbook manager. I'm the main maintainer.
...
-   **BiDiRTCS: Bidirectional Real-time Communication System:** Created a high-performance system for real-time data transmission between displays and the central system (Arrow2) at Screen Network.
...
**Soitron / Cloudpay** <Small>2023.06 - current</Small>

-   Senior Fullstack NodeJS Developer (Contract)
-   Joined during the concluding phase of the project, contributing to both frontend (React) and backend microservices (NestJS + AWS) on an internal contract management system. Utilized JFrog for provisioning several internal tooling as packages.

**Intechnica / Netacea** <Small>2022-2023</Small>
...
**Handsontable** <Small>2020-2022</Small>
...
As an experienced software developer, I have a strong focus on React, TypeScript, JavaScript, and open-source technologies. Skilled in working with multiple frameworks, databases, and languages, I possess a solid background in team leadership, project management, and mentoring.
