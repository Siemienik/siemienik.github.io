...
* [ExcelJS](https://github.com/exceljs/exceljs) (over 10200 :star:) - Since 2019, a volunteer maintainer, Contributor #3.
* [Handsontable](https://github.com/handsontable/handsontable/pulls?q=is%3Apr+author%3ASiemienik+) (over 17100 :star:) - 2020-2022/02, an employee.
* [XToolset](https://github.com/siemienik/xtoolset) (136 :star:) - Since 2018, founder.
* [Siemply](https://github.com/siemienik/siemply) (in develepment) - founder.
...
* Without a framework - VanillaJS: .
* Vuepress - 2021/02-2021/08 - I made app for Handsontable docs: https://handsontable.com/docs
...
* React (**My favorite one**) - since 2020/04 - Worked on SpreadsheetViewer (app founded by Handsontable) and currently on CustomerPortal for Netacea.
...
* AngularJS - 2014-2015 - I introduced it into a few projects, team leading and training other developers how to use it.
...
### Intechnica / Netacea <small>Current</small>

* From: 2022/02
* Websites: 
  * https://intechnica.com/ 
  * https://www.netacea.com/
* Role: Senior Software Developer

#### Project: Customer Portal v3

It's new generation of portal for Netacea's customers to research them insights.

*Technologies:* Nx, React, AWS CDK, AWS Lambda, 

#### Project: API

*Technologies:* Nx, AWS CDK, AWS Lambda, DynamoDB, Redis,
